...
<head>
    ...
    <!-- Title Page-->
    <title>Gesion des Produits</title>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active">
                            <a href="ajoutCour.php">
                                <i class="far fa-check-square"></i>Cours</a>
                        </li>
                    </ul>
                </nav>
            </div>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form  method="POST" action="ajoutcc.php" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="produit_input" name="nom" placeholder="nom produit" class="form-control"> 
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="time" id="marque_input" name="temp" placeholder="marque du produit" class="form-control">
                                                     <small class="help-block form-text">veuillez remplir ce chalmp</small>
                                                </div>
                                            </div>
                                           ...
                                           <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="description" id="mini-descript_input" rows="4" placeholder="Contenu..." class="form-control"></textarea>
                                                </div>
                                            </div>
