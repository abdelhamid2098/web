                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div >
                            <div >
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">tableaux cours de clients</h3>
...
<br>
                                ...
                                <h3 class="title-5 m-b-35">tableaux cours</h3>
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <div class="rs-select2--light rs-select2--md">
...
{ ?>                 
                                            ...
                                            <td>
                                                        <div class="table-data-feature">
                                                         ...
                                                         <form method="POST" action="supprimerCC.php">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Delete" name="supprimer" value="supprimer">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                               ...
                                               <td> <input type="text" name="date"></td> 
                                                ...
                                                <td><input type="text" name="hor"> </td>
                                                <td><input type="text" name="message"> </td>
                                                <td><input type="text" name="coures"> </td>
